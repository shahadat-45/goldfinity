                                        ...
                                        @if(count($weightInfo) > 0)
                                            @foreach($weightInfo as $weight)
                                                @php
                                                    ...
                                                    if ($weight->karats = 'karat18') {
                                                        $goldPrice = App\Models\Basicinfo::where('id' , 1)->first()->karat18;                                                        
                                                    }
                                                    if ($weight->karats = 'karat20') {
                                                        $goldPrice = App\Models\Basicinfo::where('id' , 1)->first()->karat20;                                                        
                                                    }
                                                    if ($weight->karats = 'karat21') {
                                                        $goldPrice = App\Models\Basicinfo::where('id' , 1)->first()->karat21;                                                        
                                                    }
                                                    if ($weight->karats = 'karat22') {
                                                        $goldPrice = App\Models\Basicinfo::where('id' , 1)->first()->karat22;                                                        
                                                    }

                                                    $cost = round(($goldPrice / 100) * $basicInfo->cost, 2);
                                                    $price = round($goldPrice * $weight->weight_name, 2);
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="productKarat">{{$weight->karats}} </span></td>
                                                    <td><input type="number" class="cost form-control" style="width:100px;" value="{{$cost}}" readonly></td>
                                                    <td><input type="number" class="goldPrice form-control" style="width:120px;" value="{{$price}}" readonly></td>
                                                    ...
                                                    <td><input type="number" class="total_qty form-control" style="width:100px;" value="{{$weight->total_qty}}"></td>
