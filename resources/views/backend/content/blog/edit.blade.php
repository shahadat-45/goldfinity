...
@section('maincontent')
    ...
    <div class="container-fluid pt-4 px-4 pb-4">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-12">
                <div class="h-100 bg-secondary rounded p-4">
                    <div class="d-flex align-items-center justify-content-center">
                        <h4 class="mb-0 mt-0 p-3 text-center">Edit Blog</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="container p-4">
                <form name="form" action="{{route('admin.blogs.update',$blog->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="title" value="{{$blog->title}}" id="ProductName" class="form-control"
                                       required>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" name="short_desc" rows="2">{{$blog->short_desc}}</textarea>
                            </div>

                            <div class="form-group mb-3">
                                <label for="ProductDetailsss">Blog Long Description <span
                                            class="text-danger">*</span></label>
                                <textarea class="form-control" id="blogLongDesc" name="long_desc" rows="10">{{$blog->long_desc}}</textarea>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <img id="mainImg" src="{{asset($blog->main_img)}}" style="height:100px;width:200px" />
                                ...
                                <div class="col-12 mb-4">
                                    <div class="form-group"
                                        ...
                                        @php
                                        $data = json_decode($blog->multiple_img);
                                        @endphp
                                        <div class="d-flex gap-1" id="oldMultipleImg">
                                        @foreach($data as $key => $value)
                                            
                                                <img src="{{asset('public/images/blog/multiple/'. $value)}}" style="height:100px; width:200px" />
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" value="{{$blog->meta_title}}" name="meta_title" id="ProductName" class="form-control"
                                           required>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <label for="ProductRegularPrice">Meta Description <span
                                                class="text-danger"></span></label>
                                    <textarea class="form-control" name="meta_desc" rows="2">{{$blog->meta_desc}}</textarea>
                                </div>

                                <div class="form-group mb-3">
                                    <label for="ProductRegularPrice">Meta Keywords <span
                                                class="text-danger"></span></label>
                                    <textarea class="form-control" name="meta_keyword" rows="2">{{$blog->meta_keyword}}</textarea>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <img id="metaImg" src="{{asset($blog->meta_image)}}" style="height:100px;width:200px" />
    ...
    <script>
        ...
        inputElement.addEventListener('change', function() {
            $('#oldMultipleImg').attr('class', 'd-none');
